...
with open("e:/ДЗ/Python_F_W/notes.csv", "r", encoding="utf-8") as file:
    for line in file:
        line = line.replace("\n", "").replace("ID: ", "")
...
while True:
    print("Добро пожаловать!!! Выберите пожалуйста действие с заметками:")
...
with open("e:/ДЗ/Python_F_W/notes.csv", "w", encoding="utf-8") as file:
    for k in collect:
